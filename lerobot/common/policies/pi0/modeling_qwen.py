...
from lerobot.common.policies.pi0.lola_with_expert import (
...
class QwenFlowMatching(nn.Module):
    ...
    def __init__(self, config: QwenConfig, init_load = False, init_path = None):
        ...
        paligemma_with_export_config = PaliGemmaWithExpertConfig(
            ...
            train_awa=self.config.train_awa,
            train_expert=self.config.train_expert,
            train_full_vlm=self.config.train_full_vlm,
